function [mn,st] = bg_model(konum,frames)
    %konum=videonun yolunu belirtcez uzantısıyla beraber
    %frames ise frame araligi demek mesela [1 2] yi arguman veririseniz 1.
    %ve 2. frameyi kullanı1 [1 100] verirseniz 1-100 arasi 100 tane frameyi alır
    ...
    stdsap = stdsap + 1;
    % donus degerleri her bir RGB bileşeni icin cell formatinda
    % olusturulmustur
    mn = { ort_resim(:,:,1) ort_resim(:,:,2) ort_resim(:,:,3)};  % framedeki her bir pikselin r,g,b seklinde ortalamalarını
